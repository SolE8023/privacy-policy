# Privacy Policy for Keeply

**Last updated: January 21, 2026**

## Introduction

This Privacy Policy describes how Keeply ("we", "our", or "the app") handles information when you use our home inventory management application.

## Information Collection

### Data Stored Locally

Keeply stores all your data **locally on your device**. This includes:

- Item information (name, brand, model, price, notes)
- Photos taken or selected for items
- Space/room organization data
...
본 개인정보처리방침은 Keeply("앱")가 가정용 물품 관리 애플리케이션 사용 시 정보를 어떻게 처리하는지 설명합니다.

## 정보 수집

### 로컬 저장 데이터

Keeply는 모든 데이터를 **사용자의 기기에 로컬로 저장**합니다. 여기에는 다음이 포함됩니다:

- 물품 정보 (이름, 브랜드, 모델, 가격, 메모)
- 물품을 위해 촬영하거나 선택한 사진
- 공간/방 구성 데이터
- 앱 설정 및 환경설정

**당사는 사용자의 개인 데이터를 외부 서버에 수집, 전송 또는 저장하지 않습니다.**
...
본 개인정보처리방침은 수시로 업데이트될 수 있습니다. 변경 사항은 위의 "최종 수정일"에 반영됩니다. 변경 후 앱을 계속 사용하면 업데이트된 정책에 동의하는 것으로 간주됩니다.
